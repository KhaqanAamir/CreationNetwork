...
const FeaturesSectionEven = (props) => {
  return (
    <>
        ...
        <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
          <div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
            <img
              src={DummyFeature1}
              alt=""
              className="object-contain h-72 sm:h-80 lg:h-[550px] xl:h-112 2xl:h-128 xl:mt-80 mb-24"
            />
          </div>
          <div className="flex flex-col justify-center text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            ...
            <p className="lg:text-lg text-md text-gray-300">{props.details}</p>
            ...
            <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
              <Link
                ...
                to={props.link1}
                className="px-8 py-3 text-md text-light font-semibold rounded capitalize bg-secondary rounded-3xl hover:translate-y-[-5px] hover: duration-100 hover:bg-secondary_hover"
              >
                Start for free
              </Link>
              <Link
...
export default FeaturesSectionEven;
